...
async function executeTask(taskName, inputs) {
  ...
  if (taskDefinition.function) {
    ...
    //   await hander(inputs)
    //   return await fetch(
    //     // CAN I CALL THIS SERVER INTERNALLY HERE ? yes
    //     `${}`,
    //     {
    //       method: "POST",
    //       headers: {
...
//       `/${process.env.NEXT_PUBLIC_env ? process.env.NEXT_PUBLIC_env : "localAsyncTasks"}/${process.env.serverUid}/${context.userId}/${taskName}`,
//       nextGenerationTask
//     );
//   }
// }
...
// //     };
// //     await saveToFirebase(
// //       `/${process.env.NEXT_PUBLIC_env ? process.env.NEXT_PUBLIC_env : "localAsyncTasks"}/${process.env.serverUid}/${accumulatedContext.userId}/${taskName}`,
// //       nextGenerationTask
// //     );
// //   }
