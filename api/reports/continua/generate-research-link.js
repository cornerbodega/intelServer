...
export default async function handler(req, res) {
  ...
  const filteredExistingReport = removeHighlightedText(
    parentReportContent,
    existingHyperlinks
  );
  ...
  const messages = [
    ...
    {
      role: "user",
      content: `${filteredExistingReport}`,
    },
  ];
