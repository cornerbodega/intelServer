...
export async function writeDraftFunction(req) {
  ...
  let messages = [
    {
      role: "system",
      content: `You are an expert at generating an interesting research report for given prompt in the areas of ${expertiseString}. You always return answers with no explanation. You always return responses in html format inside a <div id="report"></div>. The first child tag is an <h2 id="reportTitle">...</h2> within the <div id="report">. Each <div id="reportTitle">...</h2> between the <div id="report"> and conclusion has a unique id attribute.`,
    },
    {
      role: "user",
